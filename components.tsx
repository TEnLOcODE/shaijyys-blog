  ...
  return (
    <footer class="mt-20 pb-16 lt-sm:pb-8 lt-sm:mt-16">
      <p class="flex items-center gap-2.5 text-gray-400/800 dark:text-gray-500/800 text-sm">
        <span>
          Do not copy {new Date().getFullYear()} Eitan B. (aka. Shaijyy)
        </span>
...
function IconX() {
  return (
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="300" height="271" viewBox="0 0 20 20" className="inline-block w-5 h-5">
